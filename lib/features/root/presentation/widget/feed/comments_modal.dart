...
class _CommentModalState extends State<CommentModal> {
  final TextEditingController _commentController = TextEditingController();
  final Set<String> _expandedCommentIds = {}; // Track expanded replies
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final visibleReplies =
                isExpanded ? commentReplies : commentReplies.take(2).toList();
                ...
                if (commentReplies.length > 2)
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Text(
                        isExpanded ? 'Read less replies' : 'Read more replies',
