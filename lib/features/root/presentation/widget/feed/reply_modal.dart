...
//     try {
//       final usecase = GetIt.I<FetchRepliesUsecase>();
//       final result = await usecase.call(commentId: widget.commentId);
//       setState(() {
//         replies = result;
//         isLoading = false;
//       });
...
//       user: await GetIt.I<AuthSession>().getCurrentUserRef(),
//       content: content,
//       likes: [],
...
//     try {
//       final usecase = GetIt.I<AddReplyUsecase>();
//       final reply = await usecase.call(
//         commentId: widget.commentId,
//         content: content,
//       );

//       setState(() {
//         replies = replies.map((r) => r.id == tempId ? reply : r).toList();
//       });
//     } catch (e) {
//       // _showErrorDialog(ErrorHandler.handle(e));
//       setState(() {
...
//             color: Colors.white, // ✅ Preserved white background
            ...
            return Padding(
              ...
              child: Row(
                ...
                children: [
                  CircleAvatar(
                    radius: 16,
                    backgroundImage: NetworkImage(reply.user.profilePicture),
                  ),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Column(
